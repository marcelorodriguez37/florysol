...
error_reporting(E_ALL); @ini_set('display_errors', true);
	...
	$forms = array(
		'1'	=> array(
			'e11cad1d' => Array( 'email' => '', 'emailFrom' => '', 'subject' => 'Inquiry from the web page', 'sentMessage' => 'El formulario ha sido enviado.', 'object' => '{"name":"{{name}} (SKU: {{sku}}) (Precio: {{price}}) (Cant.: {{qty}})"}', 'objectRenderer' => 'StoreModule::renderFormObject', 'loggingHandler' => 'StoreModule::logForm', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'recSiteKey' => null, 'recSecretKey' => null, 'fields' => array( array( 'fidx' => '0', 'name' => 'Nombre', 'type' => 'input', 'options' => '' ), array( 'fidx' => '1', 'name' => 'E-mail', 'type' => 'input', 'options' => '' ), array( 'fidx' => '2', 'name' => 'Dirección', 'type' => 'input', 'options' => '' ), array( 'fidx' => '3', 'name' => 'Comentarios', 'type' => 'textarea', 'options' => '' ) ) ),
			'04efd30f' => Array( 'email' => '', 'emailFrom' => '', 'subject' => 'Inquiry from the web page', 'sentMessage' => 'El formulario ha sido enviado.', 'object' => '{"name":"{{name}} (SKU: {{sku}}) (Precio: {{price}}) (Cant.: {{qty}})"}', 'objectRenderer' => 'StoreModule::renderFormObject', 'loggingHandler' => 'StoreModule::logForm', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'recSiteKey' => null, 'recSecretKey' => null, 'fields' => array( array( 'fidx' => '0', 'name' => 'Nombre', 'type' => 'input', 'options' => '' ), array( 'fidx' => '1', 'name' => 'E-mail', 'type' => 'input', 'options' => '' ), array( 'fidx' => '2', 'name' => 'Dirección', 'type' => 'input', 'options' => '' ), array( 'fidx' => '3', 'name' => 'Comentarios', 'type' => 'textarea', 'options' => '' ) ) ),
			'142c5b40' => Array( 'email' => '', 'emailFrom' => '', 'subject' => 'Inquiry from the web page', 'sentMessage' => 'El formulario ha sido enviado.', 'object' => '', 'objectRenderer' => '', 'loggingHandler' => '', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'recSiteKey' => null, 'recSecretKey' => null, 'fields' => array( array( 'fidx' => '0', 'name' => 'Nombre', 'type' => 'input', 'options' => '' ), array( 'fidx' => '1', 'name' => 'E-mail', 'type' => 'input', 'options' => '' ), array( 'fidx' => '2', 'name' => 'Mensaje', 'type' => 'textarea', 'options' => '' ) ) )
		)
	);
	$langs = null;
	$def_lang = null;
	...
	$base_url = '/';
	$user_domain = 'mbrsoluciones.com';
	$show_comments = false;
	include dirname(__FILE__).'/functions.inc.php';
	require dirname(__FILE__).'/StoreModule.php';
	$home_page = '1';
	list($page_id, $lang, $urlArgs, $route) = parse_uri();
	$user_key = "p10/THshJaoCb4mG/N9KFJ4=";
	$user_hash = "034e806dc3a68981";
	...
	if (is_callable('StoreModule::parseRequest')) call_user_func('StoreModule::parseRequest', $page, $lang, $urlArgs);
	if (!is_null($page)) {
